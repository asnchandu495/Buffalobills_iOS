...
class ExampleAnimateTipsContentView3: ExampleAnimateTipsContentView {
    ...
    override init(frame: CGRect) {
        ...
        badgeView.imageView.image = UIImage.init(named: "tips2")?.resizableImage(withCapInsets: UIEdgeInsets.init(top: 10, left: 10, bottom: 15, right: 25)).withRenderingMode(.alwaysTemplate)
