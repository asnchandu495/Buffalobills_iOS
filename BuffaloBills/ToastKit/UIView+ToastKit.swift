...
public extension UIView {
    ...
    func showToast(embedding contentView: UIView, duration: TimeInterval = 0.3) {
        ...
        let topConstraint = toastView.topAnchor.constraint(equalTo: chosenTopAnchor, constant: -111)
        NSLayoutConstraint.activate([
    ...
    func hideToast(duration: TimeInterval = 0.2) {
